...
#ifndef __INET_HttpCDNBrowserDIRECT_H
#define __INET_HttpCDNBrowserDIRECT_H
 ...
 * A light-weight module which uses direct message passing is also available (HttpCDNBrowserDirect).
 *
 * @author Kristjan V. Jonsson (kristjanvj@gmail.com)
 * @version 1.0
 *
 * @see HttpCDNBrowserBase
 * @see HttpCDNBrowserDirect
 */
class INET_API HttpCDNBrowser : public HttpCDNBrowserBase, public TCPSocket::CallbackInterface
{
    protected:
        /**
